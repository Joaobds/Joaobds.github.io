				...
				return {
					...
					onShow: function () {
						for (var i = 0; i < disabled.length; i++) {
							this.getContentElement('youtubePlugin', disabled[i]).getElement().hide();
						}
					},
					contents :
						[{
								...
								},
								{
									...
									[
										...
										},
										{
											...
											'default' : editor.config.youtube_width != null ? editor.config.youtube_width : '280',
											validate : function () {
												if (this.getValue()) {
										...
										},
										{
											...
											'default' : editor.config.youtube_height != null ? editor.config.youtube_height : '158',
											validate : function () {
												if (this.getValue()) {
